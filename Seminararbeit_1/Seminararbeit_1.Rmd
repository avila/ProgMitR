...
* **age**: Replace missing values by the mean *age*. We decided not to remove or replace the outliers of *age* since the gap between them and the data is not so big.   

```{r}
  # Replace the missing values by the average age
